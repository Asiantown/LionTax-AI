#!/usr/bin/env python
"""Full benchmark with all tax categories including edge cases."""
...
print("🏆 Full Tax Questions Benchmark (All Categories)")
print("=" * 70)
...
try:
    ...
    evaluate(
        ...
        metrics=[metric],
        hyperparameters={"model": "GPT-4", "time": f"{gpt4_time:.1f}s", "questions": len(questions)}
    )
    print(" ✅")
except Exception as e:
    print(f" ❌ {e}")
